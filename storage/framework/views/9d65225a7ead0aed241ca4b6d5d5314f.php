            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="campo_nombre" style="display:none;">
                        ...
                        <input type="text" class="form-control" id="nombre_categoria" name="nombre_categoria" pattern="[a-zA-Z]+">
                    </div>

                    <div id="campo_nombre2" style="display:none;">
                        <label for="nombre_sub_categoria" class="form-label">Nombre de la subcategoría</label>
                        <input type="text" class="form-control" id="nombre_sub_categoria" name="nombre_sub_categoria" pattern="[a-zA-Z]+">
                    </div>
