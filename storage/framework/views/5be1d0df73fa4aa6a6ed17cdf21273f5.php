                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(URL::asset('/apps-invoices-details')); ?>" class="btn btn-secondary btn-sm"><i
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-16"><a
                                                        href="<?php echo e(URL::asset('/apps-ecommerce-product-details')); ?>"
                                                        class="link-primary">Sweatshirt for Men
                                                        (Pink)</a></h5>
                                    ...
                                    <td colspan="2" class="fw-medium p-0">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Discount <span
                                                            class="text-muted">(VELZON15)</span> : :
                                                    </td>
                        ...
                        <div class="flex-shrink-0 mt-2 mt-sm-0">
                            <a href="javasccript:void(0;)"
                                class="btn btn-soft-info btn-sm mt-2 mt-sm-0"><i
                                    class="ri-map-pin-line align-bottom me-1"></i> Change Address</a>
                            <a href="javasccript:void(0;)"
                                class="btn btn-soft-danger btn-sm mt-2 mt-sm-0"><i
                                    class="mdi mdi-archive-remove-outline align-bottom me-1"></i> Cancel
                                Order</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div class="accordion-item border-0">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body ms-2 ps-5 pt-0">
                                        <h6 class="mb-1">Your Item has been picked up by courier patner
                                        </h6>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" class="badge badge-soft-primary fs-12">Track
                                Order</a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Allbaute\Allbaute\resources\views/apps-ecommerce-order-details.blade.php ENDPATH**/ ?>