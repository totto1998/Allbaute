                    ...
                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                        ...
                        <tbody class="list form-check-all">
                            <tr>
                                ...
                                <td class="project_name"><a href="{{URL::asset('/apps-projects-overview')}}" class="fw-medium link-primary">Velzon - v1.0.0</a></td>
                                <td>
                                    <div class="d-flex">
                                        <div class="flex-grow-1 tasks_name">Profile Page Satructure</div>
                                        <div class="flex-shrink-0 ms-4">
                                            <ul class="list-inline tasks-list-menu mb-0">
                                                <li class="list-inline-item"><a href="{{URL::asset('/apps-tasks-details')}}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i></a>
                                                </li>
