                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <p class="text-uppercase fw-semibold fs-13 text-muted mb-1">Day
                                            Change</p>
                                        <h4 class=" mb-0">$<span class="counter-value"
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                ...
                                                <p class="fw-medium text-muted mb-0">$75.69 <span
                                                        class="text-success fs-13 ms-1">+1.99%</span>
                                                </p>
                                                <p class="fw-medium text-muted mb-0">High <span
                                                        class="text-dark fs-13 ms-1">0.014578</span></p>
                                                <p class="fw-medium text-muted mb-0">Low <span
                                                        class="text-dark fs-13 ms-1">0.0175489</span>
                                                </p>
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-6">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+13.11%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(btc)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+15.08%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(ltc)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+08.57%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(etc)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fw-medium mb-0">-09.21%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(bnb)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+12.07%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(dash)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-success fw-medium mb-0">+14.99%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(usdt)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-end g-0">
                                    <div class="col-6">
                                        ...
                                        <p class="text-danger fw-medium mb-0">-05.07%<span
                                                class="text-muted ms-2 fs-13 text-uppercase">(neo)</span>
                                        </p>
                                    </div><!-- end col -->
                                    <div class="col-6">
                                        <div class="apex-charts crypto-widget"
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                    <td><a href="{{URL::asset('/apps-crypto-buy-sell')}}" class="btn btn-sm btn-soft-secondary">Trade</a>
                                    </td>
                                </tr><!-- end -->
                                <tr>
                                    <td>
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted fs-13 mb-0">Dec 12, 2021 <i
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted fs-13 mb-0">Dec 03, 2021 <i
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted fs-13 mb-0">Nov 22, 2021 <i
                    ...
                    <div class="d-flex mt-4">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted fs-13 mb-0">Nov 18, 2021 <i
