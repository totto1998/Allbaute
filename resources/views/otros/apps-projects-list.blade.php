...
@section('content')
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="{{URL::asset('/apps-projects-create')}}" class="btn btn-success"><i
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item"
                                                href="{{URL::asset('/apps-projects-overview')}}"><i
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-16"><a href="{{URL::asset('/apps-projects-overview')}}"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-15"><a href="{{URL::asset('/apps-projects-overview')}}"
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-15 mb-3"><a href="{{URL::asset('/apps-projects-overview')}}"
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-15"><a href="{{URL::asset('/apps-projects-overview')}}"
