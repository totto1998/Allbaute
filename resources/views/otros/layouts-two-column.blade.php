                        ...
                        <table class="table table-nowrap table-centered align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" class="avatar-xxs rounded-circle me-1" alt="">
            ...
            <div class="card card-height-100">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <div class="dropdown card-header-dropdown">
                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="fw-semibold text-uppercase fs-13">Sort by: </span><span class="text-muted">Last 30 Days<i class="mdi mdi-chevron-down ms-1"></i></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-borderless table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
                                ...
                                <tr>
                                    <td class="d-flex">
                                        <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-3 me-2">
                                        <div>
