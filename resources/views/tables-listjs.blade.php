                    ...
                    <div data-simplebar style="height: 242px;" class="mx-n3">
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="1">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Jonny
                                                Stromberg</a></h5>
                            ...
                            <li class="list-group-item" data-id="2">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Jonas
                                                Arnklint</a></h5>
                            ...
                            <li class="list-group-item" data-id="3">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Martina
                                                Elm</a></h5>
                            ...
                            <li class="list-group-item" data-id="4">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Gustaf
                                                Lindqvist</a></h5>
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="01">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Jonny
                                                Stromberg</a></h5>
                            ...
                            <li class="list-group-item" data-id="02">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Jonas
                                                Arnklint</a></h5>
                            ...
                            <li class="list-group-item" data-id="03">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Martina
                                                Elm</a></h5>
                            ...
                            <li class="list-group-item" data-id="04">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Gustaf
                                                Lindqvist</a></h5>
                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link text-dark">Jonny
                                                Stromberg</a></h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link text-dark">Jonas
                                                Arnklint</a></h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link text-dark">Martina Elm</a>
                                        </h5>
                            ...
                            <li class="list-group-item">
                                <div class="d-flex align-items-center pagi-list">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14 mb-1"><a href="#" class="link text-dark">Gustaf
                                                Lindqvist</a></h5>
